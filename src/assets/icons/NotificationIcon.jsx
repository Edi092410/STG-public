export const NotificationIcon = () => {
  return (
    ...
    >
      ...
      />
      <path
        d="M15.3319 18.8203C15.3319 20.6503 13.8319 22.1503 12.0019 22.1503C11.0919 22.1503 10.2519 21.7703 9.65187 21.1703C9.05187 20.5703 8.67188 19.7303 8.67188 18.8203"
        stroke="#FEFEFE"
        strokeWidth="1.5"
        strokeMiterlimit="10"
      />
